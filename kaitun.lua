...
_G.Fruits_Settings = { -- ตั้งค่าผล
    ['Main_Fruits'] = {'Dough-Dough','Kitsune-Kitsune', 'Leopard-Leopard','Mammoth-Mammoth','Venom-Venom','T-Rex-T-Rex','Rumble-Rumble','Spirit-Spirit'}, -- ผลหลัก ถ้ายังไม่ใช่ค่าที่ตั้งมันจะกินจนกว่าจะใช่หรือซื้อ
